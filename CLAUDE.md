...
- 2026-04-19 – Simulations-UI fuer Demo: globale Slider (Uhrzeit/Tag), pro Produkt Lager-/Verbrauchs-Slider mit Live-Preisberechnung; Product-Felder `context`, `monthly_demand`, `daily_usage`; Formel-Evaluator akzeptiert Runtime-Variablen `hour`, `day`, `stock`, `usage`; neuer Endpoint `POST /products/{id}/strategy/suggest` (KI-Vorschlag Fix/Formel mit optionaler Online-Recherche) – Migration 0002.
